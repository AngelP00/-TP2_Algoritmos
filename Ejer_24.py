...
def mostrar_todos_los_personajes_cuyos_nombres_empiezan_con_x_letras(pila, x):
    pila_aux= Pila()
    while(not pila.pila_vacia()):
        personanje = pila.desapilar()
...
x = ['C','D', 'G']
mostrar_todos_los_personajes_cuyos_nombres_empiezan_con_x_letras(pila_personajes, x)